...
const Home = () => {
  return (
    <main className='page'>
      ...
      similique, sit perspiciatis labore natus quia corrupti velit rerum officia
      omnis obcaecati sunt architecto earum nihil. Voluptatibus, est dicta?
      Perspiciatis deserunt commodi amet, ipsam fuga sed laudantium inventore
      tenetur suscipit.
    </main>
  );
};
